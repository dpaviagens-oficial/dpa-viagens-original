  ...
  return (
    ...
    >
      <a 
        ...
        className="block bg-[#25D366] p-3 sm:p-4 rounded-full shadow-[0_10px_25px_rgba(37,211,102,0.4)] hover:shadow-[0_15px_35px_rgba(37,211,102,0.6)] transition-all duration-300 hover:-translate-y-1 hover:scale-110"
        aria-label="WhatsApp"
      >
        <svg 
          viewBox="0 0 24 24" 
